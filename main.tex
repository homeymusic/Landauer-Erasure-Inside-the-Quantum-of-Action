...
\section{Equations}
\begin{equation}
\label{eq:SimpleLanguage}
\text{Erasure Action} \le \text{Phase Space Area}
\end{equation}
...
\begin{equation}
\label{eq:ActionArea}
(K_q + K_p) E_L \tau \le \frac{A}{\pi \hbar} (A_q + A_p)
\end{equation}

\begin{equation}
\label{eq:QuantumOfAction}
A_{\delta q} + A_{\delta p} = \pi \hbar
\end{equation}

\begin{equation}
\label{eq:ActionAreas}
A_q = \frac{\pi}{4} \delta q \Delta p \quad \text{and} \quad A_p = \frac{\pi}{4}\delta p \Delta q
\end{equation}
