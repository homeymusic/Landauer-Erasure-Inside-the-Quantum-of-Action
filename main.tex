...
\begin{equation}
\label{eq:BitBudgetPlain}
\text{Available Bits} \propto \text{Classical Conjugate}
\end{equation}
...
\begin{quote}
``It is easier for a camel to pass through the eye of a needle than for one who is rich to enter the kingdom of God.'' \cite{DeGosson2009Iceberg}
\end{quote}
\begin{quote}
...
\subsection{The Principle of Least Abbreviated Action}
...
\begin{equation}
\label{eq:ConjugateActionErasureArea}
(K_q + K_p) E_L \tau = \frac{A}{h} (\pi |\epsilon_q| \Delta p + \pi \Delta q |\epsilon_p|) \le A
\end{equation}

\begin{equation}
\label{eq:PrincipleOfLeastAbbreviatedAction_q}
\oint p \, dq = \pi \left( \frac{A}{h} |\epsilon_q| \right) \Delta p
\end{equation}

\begin{equation}
\label{eq:PrincipleOfLeastAbbreviatedAction_p}
\left| \oint q \, dp \right| = \pi \left( \frac{A}{h} |\epsilon_p| \right) \Delta q
\end{equation}

\begin{equation}
\label{eq:MaupertuisVariation_q}
\delta \oint p \, dq = \pi \left( \frac{A}{h} \right) \Delta p \, \delta |\epsilon_q| = 0
\end{equation}

\begin{equation}
\label{eq:MaupertuisVariation_p}
\delta \left| \oint q \, dp \right| = \pi \left( \frac{A}{h} \right) \Delta q \, \delta |\epsilon_p| = 0
\end{equation}

\begin{equation}
\label{eq:PrincipleOfLeastAbbreviatedAction}
\delta |\epsilon_q| = 0 \quad \text{and} \quad \delta |\epsilon_p| = 0
\end{equation}
...
\begin{itemize}
    ...
    \item \textbf{Principle of Least Abbreviated Action}
    \begin{itemize}
        \item Arnold \cite{Arnold1989}
    \end{itemize}
