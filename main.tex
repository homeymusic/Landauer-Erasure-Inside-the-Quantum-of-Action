...
\text{Thermodynamic Erasure} \approx \text{Kinematic Encoding}
\end{equation}
...
\caption{\textbf{The quantum of action} (schematic, 1D case). By geometrically translating the statistical Heisenberg limit, $\sigma_q \sigma_p \ge \hbar/2$, the classical semi-axes $\Delta q = \sqrt{2}\sigma_q$ and $\Delta p = \sqrt{2}\sigma_p$ establish the relation $\pi \Delta q \Delta p \ge h/2$. In phase space, this is the classical action area, $A \ge h/2$. Confined by these classical boundaries, the interior resolves into a conjugate pair of symplectic quantum blobs, $a_q = h/2$ and $a_p = h/2$, whose sum is the quantum of action, $h$. Specifically, $a_q$ is squeezed by the reciprocal boundary $\delta q = \hbar / \Delta p$ to area $\pi \delta q \Delta p = h/2$, while $a_p$ is squeezed by $\delta p = \hbar / \Delta q$ to area $\pi \Delta q \delta p = h/2$. These centered, orthogonal ellipses enclose their interior ellipse with quantum action area, $a \le h/2$, evaluated as $\pi \delta q \delta p = \pi \hbar^2/(\Delta q \Delta p)$. This inverse scaling geometrically enforces the correspondence principle: as the classical action area $A \ge h/2$ increases, the symplectic blobs $a_q=h/2$ and $a_p=h/2$ compress into fine cross hairs, shrinking the enclosed quantum action area $a \le h/2$ (see Fig.~\ref{fig:encoding_grid}). This symplectic hierarchy establishes quantum and classical relationships $a \le h/2 \le A$ and $a = (\pi \hbar)^2 / A$.}
...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=\linewidth]{figures/encoding_tree.png}
\caption{\textbf{Kinematic encoding and thermodynamic erasure tree} (schematic).}
\label{fig:encoding_tree}
\end{figure*}
