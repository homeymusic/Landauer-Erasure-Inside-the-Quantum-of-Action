...
Applying this dual-capacity definition of $h$ to the erasure limit (Eq.~\ref{eq:Hero}) partitions the thermodynamic cost into its coordinate and momentum components:
