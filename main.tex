...
\text{Quantum of Action} = \text{Squeezed Symplectic Areas}
\end{equation}
...
\text{Uncertainty} \propto \frac{1}{\text{System Phase Space Area}}
\end{equation}

\begin{equation}
\label{eq:GeometricUncertaintyPrinciple}
\pi \delta q \delta p = \frac{h^2}{4A}
\end{equation}
...
\delta q - |\epsilon_q| \quad \text{and} \quad \delta p - |\epsilon_p| 
\end{equation}
...
\text{Available Bits} \propto \text{Classical Conjugate Limit}
\end{equation}
...
\begin{itemize}
    ...
    \item \textbf{Principle of Least Action}
    \begin{itemize}
        \item Feynman \cite{Feynman1948}
    \end{itemize}
